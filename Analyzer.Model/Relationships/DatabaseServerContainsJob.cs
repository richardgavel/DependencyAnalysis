...
{
    public class DatabaseServerContainsJob : AbstractContainsRelationship, IRelationshipAllowingSourceNode<DatabaseServer>, IRelationshipAllowingTargetNode<Job>
    {
