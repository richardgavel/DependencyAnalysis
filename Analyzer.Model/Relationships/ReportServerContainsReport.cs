...
{
    public class ReportServerContainsReport : AbstractContainsRelationship, IRelationshipAllowingSourceNode<ReportServer>, IRelationshipAllowingTargetNode<Report>
    {
